...
impl Spot for SevenLevelNestTestSpot {
    fn initialize(ctx: &mut Context) -> Self {
        ...
        images.push(Image::new_from_rgba8(ctx, Pt::from(200.0), Pt::from(200.0), &rgba).unwrap());
        ...
        images.push(Image::new_from_rgba8(ctx, Pt::from(100.0), Pt::from(100.0), &rgba).unwrap());
