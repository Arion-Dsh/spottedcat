...
impl Spot for TextApp {
    ...
    fn draw(&mut self, context: &mut Context) {
        ...
        opts.font_size = spottedcat::Pt::from(32.0);
        ...
        custom_opts.font_size = spottedcat::Pt::from(28.0);
        custom_opts.color = [1.0, 0.5, 0.0, 1.0]; // 橙色
        custom_opts.stroke_width = spottedcat::Pt::from(2.0);
        ...
        file_opts.font_size = spottedcat::Pt::from(24.0);
        ...
        small_opts.font_size = spottedcat::Pt::from(18.0);
        ...
        large_opts.font_size = spottedcat::Pt::from(48.0);
