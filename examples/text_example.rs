...
impl Spot for TextApp {
    ...
    fn draw(&mut self, context: &mut Context) {
        ...
        let custom_opts = DrawOption::default()
            .with_position([spottedcat::Pt::from(100.0), spottedcat::Pt::from(150.0)]);
        ...
        let file_opts = DrawOption::default()
        ...
        let small_opts = DrawOption::default()
            .with_position([spottedcat::Pt::from(100.0), spottedcat::Pt::from(340.0)]);
        ...
        let large_opts = DrawOption::default()
            .with_position([spottedcat::Pt::from(100.0), spottedcat::Pt::from(300.0)]);
